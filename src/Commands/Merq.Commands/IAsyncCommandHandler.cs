...
namespace Merq
{
	...
	public interface IAsyncCommandHandler<in TCommand> : IAsyncCommandHandler, ICanExecute<TCommand> where TCommand : ICommand
	{
		/// <summary>
	...
	/// </devdoc>
	public interface IAsyncCommandHandler<in TCommand, TResult> : IAsyncCommandHandler, IExecuteResult, ICanExecute<TCommand> where TCommand : ICommand<TResult>
	{
		/// <summary>
		/// Executes the command asynchronously.
		/// </summary>
