...
namespace Merq
{
	...
	{
		MethodInfo canHandleMethod = typeof(CommandBus)
			.GetTypeInfo()
		...
		public CommandBus([Import(typeof(Microsoft.VisualStudio.Shell.SVsServiceProvider))] IServiceProvider services)
			: this((IComponentModel)services.GetService(typeof(SComponentModel)))
		{ 
		}

		public CommandBus(IComponentModel components)
		{
