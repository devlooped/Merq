...
namespace Merq
{
    ...
    {
        ConcurrentDictionary<Type, Lazy<ICommandHandler>> handlerMap = new ConcurrentDictionary<Type, Lazy<ICommandHandler>>();
        ConcurrentDictionary<Type, VoidExecutor> voidExecutors = new ConcurrentDictionary<Type, VoidExecutor>();
        ConcurrentDictionary<Type, VoidAsyncExecutor> voidAsyncExecutors = new ConcurrentDictionary<Type, VoidAsyncExecutor>();
        ConcurrentDictionary<Type, ResultExecutor> resultExecutors = new ConcurrentDictionary<Type, ResultExecutor>();
        ConcurrentDictionary<Type, ResultAsyncExecutor> resultAsyncExecutors = new ConcurrentDictionary<Type, ResultAsyncExecutor>();
